package com.parimal.e_wholesaler.order_service.aspects;

import com.parimal.e_wholesaler.order_service.exceptions.UnAuthorizedAccessException;
...
public class SecurityAspect {
    ...
    @Pointcut(value = "execution(public * com.parimal.e_wholesaler.order_service.services..*(..)) && " +
            "!execution(* com.parimal.e_wholesaler.order_service.services.JwtService.*(..))")
