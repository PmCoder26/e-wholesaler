package com.parimal.e_wholesaler.product_service.aspects;
...
public class SecurityAspect {
    ...
    @Pointcut(value = "execution(public * com.parimal.e_wholesaler.product_service.services..*(..)) && " +
            "!execution(* com.parimal.e_wholesaler.product_service.services.JwtService.*(..))")
