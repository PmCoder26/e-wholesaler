package com.parimal.e_wholesaler.common.utils;

import com.parimal.e_wholesaler.common.enums.Permission;
...
import static com.parimal.e_wholesaler.common.enums.Permission.*;
import static com.parimal.e_wholesaler.common.enums.UserType.*;
...
public class PermissionMapping {
    ...
    private static final Map<UserType, Set<Permission>> map = Map.of(
            OWNER, Set.of(
                    ...
                    PRODUCT_VIEW, PRODUCT_CREATE, SHOP_PRODUCT_UPDATE, SHOP_PRODUCT_DELETE,
